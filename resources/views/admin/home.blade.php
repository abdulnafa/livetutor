            ...
            <div class="col-md-6 col-lg-3 col-xlg-3">
              <div class="card card-hover">
                <div class="box bg-cyan text-center">
                  ...
                  <h3 class="text-white">{{$pendingordernumber}}</h3>
            ...
            <div class="col-md-6 col-lg-3 col-xlg-3">
              <div class="card card-hover">
                <div class="box bg-success text-center">
                  ...
                  <h3 class="text-white">{{$progressordernumber}}</h3>
                  <h6 class="text-white">In Progress Order</h6>
                </div>
              </div>
            </div>
            <!-- Column -->
            <div class="col-md-6 col-lg-3 col-xlg-4">
              <div class="card card-hover">
                <div class="box bg-warning text-center">
                  ...
                  <h3 class="text-white">{{$revisionordernumber}}</h3>
                  <h6 class="text-white">Revision Order</h6>
                </div>
              </div>
            </div>
            <!-- Column -->
            <div class="col-md-6 col-lg-3 col-xlg-4">
              <div class="card card-hover">
                <div class="box bg-danger text-center">
                  ...
                  <h3 class="text-white">{{$completedordernumber}}</h3>
