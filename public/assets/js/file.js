...
$(".singlepricesideboxfixed").html($(this).val());



total=Number($(".pagesideboxfixed").html())*Number($(".singlepricesideboxfixed").html());
...
// Number Of Pages 
           $(".countingrowpage .myminus").on("click",function(){
                ...
                if(mycountnumber==0){
                    ...
                    total=mycountnumber*Number($(".singlepricesideboxfixed").html()).toFixed(2);
$(".totalchangedsidebarfixed").html(total.toFixed(2));
$("#totalamount").val(total.toFixed(2));
                }
...
if($(this).attr("id")==getcurrentcurrency){
 ...
 $(".sourcecountingrowpage .myminus").on("click",function(){
    mysourececountnumber=parseInt($(".sourcecountingrowpage .mycount").html());
...
// Source to be cited End 
 ...
 $(".powerpointslidecountingrowpage .myminus").on("click",function(){
    mycountnumber=Number($(".powerpointslidecountingrowpage .mycount").html());
